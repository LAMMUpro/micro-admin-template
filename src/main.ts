  ...
  subAppSettingList: [
    {
      ...
      routerMode: 'hash',
      urlMap: {
        localhost: '//127.0.0.1:1323/react18/',
        test: '//szhgg.ifuhua.com.cn/react18/',
        pre: '//szhgg.bokeyun.com.cn/react18/',
        master: '//szhgg.boshiyun.com.cn/react18/',
      },
      builder: 'vite',
      iframe: true,
      framework: 'react18',
    },
    {
      ...
      routerMode: 'hash',
      urlMap: {
        localhost: '//127.0.0.1:2030/admin/',
        test: '//szhgg.ifuhua.com.cn/admin/',
        pre: '//szhgg.bokeyun.com.cn/admin/',
        master: '//szhgg.boshiyun.com.cn/admin/',
      },
      builder: 'vite',
      iframe: true,
      framework: 'vue3',
    },
    {
      ...
      routerMode: 'hash',
      urlMap: {
        localhost: '//127.0.0.1:2035/workFlow/',
        test: '//szhgg.ifuhua.com.cn/workFlow/',
        pre: '//szhgg.bokeyun.com.cn/workFlow/',
        master: '//szhgg.boshiyun.com.cn/workFlow/',
      },
      builder: 'webpack',
      iframe: false,
      framework: 'vue2',
